 function [ u_star, z_pos_star, z_neg_star, obj_sub, time_sub ,idx_wrst] = CCG_second_stage_AD_try( normal_input_23, smodel_z_star, mat_B, mat_C, mat_D, mat_F, mat_G, vec_d, vec_e, vec_f, vec_g, vec_h, vec_u0, vec_du_pos, vec_du_neg, x_star, w_max, zpos0_set, zneg0_set, ADiter_max, ADtol_rel)
% Second-stage of C&CG solved by alternating direction method
...
%     idx=1;
    ...
    [u_temp, z_pos_temp, z_neg_temp, obj_temp, time_temp, solved_temp] = alternating_direction(fixz, fixw, mat_B, mat_C, vec_u0, vec_du_pos, vec_du_neg, x_star, vec_e, vec_g, zpos0, zneg0, var_u, ADiter_max, ADtol_rel);    
