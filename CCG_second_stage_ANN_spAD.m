function [ u_star, z_pos_star, z_neg_star, obj_sub, time_sub] = CCG_second_stage_ANN_spAD( normal_input_23, smodel_z_star, mat_B, mat_C, mat_D, mat_F, mat_G, vec_d, vec_e, vec_f, vec_g, vec_h, vec_u0, vec_du_pos, vec_du_neg, x_star, w_max, ADiter_max, ADtol_rel)
...
%     pop = floor(idx/n_z0*10);
    [u_temp, z_pos_temp, z_neg_temp, obj_temp, time_temp] = alternating_direction_ANN_spAD(normal_input_model, smodel_z_star, fixz, fixw, mat_B, mat_C, vec_u0, vec_du_pos, vec_du_neg, x_star, vec_e, vec_g, var_u,ADiter_max, ADtol_rel);    
    obj_sub = obj_temp;
    u_star = u_temp;
