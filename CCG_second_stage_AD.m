 function [ u_star, z_pos_star, z_neg_star, obj_sub, time_sub,idx_wrst ] = CCG_second_stage_AD( mat_B, mat_C, mat_D, mat_F, mat_G, vec_d, vec_e, vec_f, vec_g, vec_h, vec_u0, vec_du_pos, vec_du_neg, x_star, w_max, zpos0_set, zneg0_set, ADiter_max, ADtol_rel)
