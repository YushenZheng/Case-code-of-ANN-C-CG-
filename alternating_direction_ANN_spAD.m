function [u_temp, z_pos_temp, z_neg_temp, obj_temp, time_temp] = alternating_direction_ANN_spAD(normal_input_model, smodel_z_star, fixz, fixw, mat_B, mat_C, vec_u0, vec_du_pos, vec_du_neg, x_star, vec_e, vec_g, var_u, ADiter_max, ADtol_rel)
global num_u;
